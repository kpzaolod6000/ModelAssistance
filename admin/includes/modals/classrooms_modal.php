<!-- Add -->
<div class="modal fade" id="addnew_classrooms">
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Agregar Aula</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="asignatures_add.php">
                <div class="form-group">
                  	<label for="nro_class" class="col-sm-3 control-label">Nro de Aula</label>

                  	<div class="col-sm-9">
                    	<input type="number" class="form-control" id="nro_class" name="nro_class">
                  	</div>
                </div>
          	...
          	<div class="modal-footer">
            	...
            	<button type="submit" class="btn btn-primary btn-flat" name="add_classroom"><i class="fa fa-save"></i> Guardar</button>
            	</form>
          	</div>
        </div>
    </div>
